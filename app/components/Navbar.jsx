  ...
  return (
    <div className="w-full h-[78px] flex justify-center items-center shadow-md">
      <div className="w-[1120px] h-[48px] flex items-center justify-between">
        <img src={Logo.src} alt="Logo"  onClick={() => handleNavigation('/home')}/>
        <div className="w-[447px] h-[40px] flex items-center justify-between">
          <p
            className="text-[#161616] font-semibold text-[14px]"
        ...
        <button className="text-[#F15D22] text-[18px] border-[1.8px] border-[#F15D22] w-[118px] h-[48px] rounded-[50px]">
          Нэвтрэх
        </button>
      </div>
    </div>
